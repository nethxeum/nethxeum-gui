...
function getApproximateBlockchainHeight(_date, _nettype){
    // time of nethxeum birth 2014-04-18 10:49:53 (1397818193)
    var nethxeumBirthTime = _nettype == "Mainnet" ? 1397818193 : _nettype == "Testnet" ? 1410295020 : 1518932025;
    ...
    var secondsPerBlock;
    // before nethxeum's birth
    if (requestedTime < nethxeumBirthTime){
        console.log("Calculated blockchain height: 0, requestedTime < nethxeumBirthTime " );
        return 0;
    }
    // time between during v1
    if (requestedTime > nethxeumBirthTime && requestedTime < forkTime){
        approxBlockchainHeight = Math.floor((requestedTime - nethxeumBirthTime)/secondsPerBlockV1);
