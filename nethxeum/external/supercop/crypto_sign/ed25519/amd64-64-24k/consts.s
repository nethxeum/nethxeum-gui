#ifdef __APPLE__
  #define NETHXEUM_LOCAL_SYMBOL(x) .private_extern x
#else
  #define NETHXEUM_LOCAL_SYMBOL(x) .hidden x
#endif
...
NETHXEUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_121666)
NETHXEUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU0)
NETHXEUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU1)
NETHXEUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU2)
NETHXEUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU3)
NETHXEUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU4)
NETHXEUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER0)
NETHXEUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER1)
NETHXEUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER2)
NETHXEUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER3)
NETHXEUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D0)
NETHXEUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D1)
NETHXEUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D2)
NETHXEUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D3)
NETHXEUM_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_38)
