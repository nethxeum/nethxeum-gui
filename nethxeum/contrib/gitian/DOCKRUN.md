...
*Setup instructions for a Gitian build of nethxeum using Docker.*
...
You'll also need to clone the nethxeum repository and navigate to the `contrib/gitian` directory:

```bash
git clone https://github.com/nethxeum/nethxeum.git
cd nethxeum/contrib/gitian
```
...
* a fork of the [gitian.sigs](https://github.com/nethxeum/gitian.sigs/) repo on your GitHub account.
