...
RUN	git clone https://github.com/nethxeum/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/nethxeum/nethxeum
...
if [ ! -d sigs ]; then
	git clone https://github.com/nethxeum/gitian.sigs.git sigs
	cd sigs
