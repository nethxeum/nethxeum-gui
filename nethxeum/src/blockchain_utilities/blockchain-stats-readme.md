# nethxeum Blockchain Stats

nethxeum Blockchain Stats utlity exports daily statistics for the nethxeum blockchain from creation through current state.

## Usage:

See also the utility's help option. `nethxeum-blockchain-stats --help`
...
- `nethxeum-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `nethxeum-blockchain-stats | save-to-database.sh`
