...
MouseArea {
    ...
    Menu {
        ...
        background: Rectangle {
            border.color: NethxeumComponents.Style.buttonBackgroundColorDisabledHover
            border.width: 1
            radius: 2
            color: NethxeumComponents.Style.blackTheme ? NethxeumComponents.Style.buttonBackgroundColorDisabled : "#E5E5E5"
        }
        ...
        NethxeumComponents.ContextMenuItem {
