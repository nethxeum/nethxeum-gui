...
MenuItem {
    ...
    background: Rectangle {
        color: NethxeumComponents.Style.buttonBackgroundColorDisabledHover
        opacity: 0
    ...
    contentItem: RowLayout {
        ...
        Text {
            ...
            color: NethxeumComponents.Style.buttonTextColor
        ...
        Text {
            color: NethxeumComponents.Style.blackTheme ? NethxeumComponents.Style.buttonTextColor : NethxeumComponents.Style.defaultFontColor
