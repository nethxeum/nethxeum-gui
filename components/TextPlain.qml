...
Text {
    ...
    Rectangle {
        ...
        color: root.focus ? NethxeumComponents.Style.titleBarButtonHoverColor : "transparent"
    }
    ...
    NethxeumEffects.ColorTransition {
        ...
        targetObj: root
        duration: 750
        blackColor: root.themeTransitionBlackColor !== "" ? root.themeTransitionBlackColor : NethxeumComponents.Style._b_defaultFontColor
        whiteColor: root.themeTransitionWhiteColor !== "" ? root.themeTransitionWhiteColor : NethxeumComponents.Style._w_defaultFontColor
    }
