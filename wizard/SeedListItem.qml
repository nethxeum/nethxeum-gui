...
ColumnLayout {
    ...
    RowLayout {
        ...
        NethxeumComponents.Label {
            color: lineEdit.inputHasFocus ? NethxeumComponents.Style.defaultFontColor : NethxeumComponents.Style.dimmedFontColor
            fontSize: 13
            text: (wordNumber + 1)
        ...
        NethxeumComponents.TextPlain {
            ...
            color: wordsMatch ? (NethxeumComponents.Style.blackTheme ? "#00FF00" : "#008000") : "#FF0000"
            themeTransition: false
            onTextChanged: {
    ...
    Rectangle {
        id: underLine
        color: lineEdit.inputHasFocus ? NethxeumComponents.Style.defaultFontColor : NethxeumComponents.Style.appWindowBorderColor
